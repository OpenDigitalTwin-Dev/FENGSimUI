...
#    Transport/data_analyze.cpp \
    Riveting/RivetingDockWidget.cpp \
    include/test.cpp \
    qcustomplot.cpp \
    AboutDialog.cpp \
...
FORMS    += \
    ...
    Riveting/RivetingDockWidget.ui \
